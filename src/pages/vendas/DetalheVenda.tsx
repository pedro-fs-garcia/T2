...
export default class DetalheVenda extends Component<Props, State> {
    ...
    handleSubmit = (e: React.FormEvent) => {
        ...
        try {
            ...
            if (tipo === 'produto') {
                ...
                this.setState({ mensagem: 'Venda de produto registrada com sucesso!' });
            } else {
                const servico = new Servico(null, nome, preco);
                servico.registrarVenda(quantidade);
                this.setState({ mensagem: 'Venda de serviço registrada com sucesso!' });
            }
        } catch (error) {
            this.setState({
                        ...
                        <div className="card shadow-sm">
                            ...
                            <form onSubmit={this.handleSubmit}>
                                <div className="card-body">
                                    ...
                                    {tipo === 'produto' &&
                                        this.renderField('Estoque Atual', quantidadeEstoque, 'quantidadeEstoque', 'number', true)}
                                    ...
                                    <div className="mt-4 d-flex justify-content-between">
                                        <Link to="/vendas" className="btn btn-outline-secondary">Voltar</Link>
                                        {editar && (
